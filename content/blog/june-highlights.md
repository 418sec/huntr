...
There will be a 24-hour buffer on all bounties once the first review is complete.If multiple fixes are received we will choose the winner based on the following criteria:  1. Accepted by repo 2. Most robust fix 3. Quickest fix
