...
`ntfserver` is a Network Testing Framework Server, this package is vulnerable to Man in the Middle (MitM) attacks due to downloading resources over an insecure protocol.
