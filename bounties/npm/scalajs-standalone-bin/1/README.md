...
`scalajs-standalone-bin` is a Binary wrapper for ScalaJS, this package is vulnerable to Man in the Middle (MitM) attacks due to downloading resources over an insecure protocol.
